...
static const OptionItem optControls[] = {
    ...
    OptionItem( OptionItem::TYPE_PARAM,  STR_OPT_CONTROLS_CHARACTER  , SETTINGS( controls[0].character          ), STR_CH_MARIO,  0, 2 ),
    OptionItem( OptionItem::TYPE_PARAM,  STR_OPT_CONTROLS_MARIO      , SETTINGS( controls[0].marioTankMode      ), STR_CH_CAMERA, 0, 1 ),
