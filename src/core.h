    ...
    // player 1
        {
            ...
            ctrl.keys[ cJump      ] = KeySet( ikX,      jkA      );
            ctrl.keys[ cWalk      ] = KeySet( ikShift,  jkRT     );
            ctrl.keys[ cAction    ] = KeySet( ikC,      jkX      );
            ctrl.keys[ cWeapon    ] = KeySet( ikSpace,  jkY      );
            ctrl.keys[ cLook      ] = KeySet( ikCtrl,   jkLT     );
            ctrl.keys[ cDuck      ] = KeySet( ikZ,      jkLB     );
            ctrl.keys[ cDash      ] = KeySet( ikS,      jkRB     );
